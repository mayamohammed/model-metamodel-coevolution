 ...
 * DatasetBuilder
 *
 * Builds the ML dataset from metamodel change feature vectors.
 * Each entry = one metamodel pair (v1, v2) + its features + its label.
 *
...
public class DatasetBuilder {
    ...
    // ── Add entry ─────────────────────────────────────────────────
    /**
     * Adds one entry to the dataset.
     *
     * @param pairId   unique identifier of the metamodel pair
     * @param features map of feature name -> value
     * @param label    change type label
     */
    ...
    /**
     * Returns entries filtered by label.
     */
    ...
    /**
     * Returns label distribution: label -> count.
     */
    ...
    /**
     * Returns one CSV line for a given entry.
     */
    ...
    /**
     * Returns the full dataset as CSV string.
     */
    public String toCsv() {
        StringBuilder sb = new StringBuilder();
