...
public class MainController implements Initializable {
    ...
    // ============================================================
    // ✅ AI CONFIG — Alert dark moderne
    // ============================================================
    @FXML
    private void onConfigureAI(ActionEvent e) {
        // Vérifier le statut API en direct
    ...
    // ============================================================
    // ALERT HELPERS — dark theme
    // ============================================================

    /** Alert info générique dark réutilisable */
    ...
    /** Applique le thème dark GitHub à toutes les Alert */
    private void styleAlert(Alert alert, boolean isError) {
        ...
        // Supprimer l'icône JavaFX par défaut
 ...
 private void onRunMigration(ActionEvent e) {
     ...
     Task<MigrationUiResult> task = new Task<>() {
         ...
         protected MigrationUiResult call() throws Exception {
             ...
             // ✅ Détection robuste du projectRoot
 ...
 // ============================================================
 // HELPER — détection robuste du projectRoot
 // ============================================================
 private File detectProjectRoot() {
    ...
    private void disableMigrationButtons(boolean disable) {
        ...
        if (btnOpenAtlFile    != null) btnOpenAtlFile.setDisable(disable);     // ✅ AJOUT 4
    }
