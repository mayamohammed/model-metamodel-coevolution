 ...
 *
 * Usage:
 *   java -jar coevolution-cli.jar predict  [options]
 *   java -jar coevolution-cli.jar diff     [options]
 *   java -jar coevolution-cli.jar report   [options]
 *   java -jar coevolution-cli.jar help
 *
 * Semaine 6 - API + CLI
 */
public class Main {
